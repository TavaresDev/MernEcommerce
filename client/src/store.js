...
import {productCreateReducer, productDeleteReducer, productDetailsReducer, productListReducer, productReviewCreateReducer, productUpdateReducer, productTopRatedReducer} from './reducers/productReducers.js'
...
const shippingAddressFromStorage = localStorage.getItem('shippingAddrress') ? JSON.parse(localStorage.getItem('shippingAddress')) : []
